module bullet2.BulletSoftBody.btSoftBodyData;
...
{
	SoftBodyMaterialData *m_material;
	int[2] m_nodeIndices;  // Node pointers
...
struct SoftBodyFaceData
{
	...
	SoftBodyMaterialData *m_material;
	int[3] m_nodeIndices;  // Node pointers
	float m_restArea;      // Rest area
};

struct SoftBodyTetraData
{
	btVector3FloatData[4] m_c0;  // gradients
	SoftBodyMaterialData *m_material;
	int[4] m_nodeIndices;  // Node pointers
...
struct SoftBodyClusterData
{
	...
	btVector3FloatData[2] m_vimpulses;
	btVector3FloatData[2] m_dimpulses;
...
struct btSoftBodyJointData
{
	void *m_bodyA;
	void *m_bodyB;
	btVector3FloatData[2] m_refs;
	float m_cfm;
	float m_erp;
	float m_split;
	int m_delete;
	btVector3FloatData[2] m_relPosition;  //linear
	int m_bodyAtype;
	int m_bodyBtype;
	int m_jointType;
	int m_pad;
